        ...
        for bbox_id, (x1_norm, y1_norm, x2_norm, y2_norm) in enumerate(bboxes):
            ...
            if mode == 'all':
                ...
                if not skip_flag:
                    ...
                    draw.text((x1, y1 - text_offset_original - 3 * text_spaces), entity_name, (255, 255, 255), font)
                    new_image = cv2.cvtColor(np.array(pil_img), cv2.COLOR_RGB2BGR)
...
title = """<h1 align="center">通见视觉大模型</h1>"""
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            chatbot = gr.Chatbot(label='通见视觉大模型')
